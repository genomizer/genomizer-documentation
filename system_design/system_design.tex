...
\input{system_design/des_systemdesign}
\FloatBarrier

\section{Web application}
\input{system_design/web_systemdesign}
\input{system_design/adm_web_systemdesign}
\FloatBarrier

\section{Android application}
\input{system_design/and_system}
\FloatBarrier

\section{iOS application}
\input{system_design/ios_systemdesign}
\FloatBarrier
...
\input{system_design/com_systemdesign}
\FloatBarrier
\subsection{Data Conversion}
\input{system_design/con_systemdesign}
\FloatBarrier
\subsection{File-transfer}
\input{system_design/exp_systemdesign}
\FloatBarrier
\subsection{Data Storage}
\input{system_design/dat_systemdesign}
\FloatBarrier
\subsection{Apache}
\input{system_design/exp_apache}
\FloatBarrier
