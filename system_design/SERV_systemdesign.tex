...
\term{RawToProfProcessCommand} and do all the different steps needed to make a \term{profile
file}. These steps are done by using different scripts which are executed with methods that is extended from
\term{Executor} class. 
