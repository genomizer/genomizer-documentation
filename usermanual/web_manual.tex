...
\begin{sidewaysfigure}[h]
\centering
\includegraphics[width=0.8\textwidth]{web_search_searchResult.png}
...
\begin{sidewaysfigure}[h]
\centering
\includegraphics[width=0.8\textwidth]{web_search_noResult.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{web/manual/web_remove.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{web_processStatus_withData.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{web_processStatus_noData.png}
...
% new, empty, experiment? Instead of new empty experiment? Why the commas?
...
\begin{sidewaysfigure}[t]
 \addImage{web_SysadminCreateAnnotation.jpg}\textbf{•}
...
\begin{figure}[h]
 \addImage{web_SysadminUploadGenomeReleaseModal.jpg}
