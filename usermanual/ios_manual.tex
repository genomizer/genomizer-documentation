...
\end{figure}
\FloatBarrier
The user can also move files to the selected files view. This is done by pressing the star to the right of the filename as seen in the left view in \refer{fig:ios_files3}.
