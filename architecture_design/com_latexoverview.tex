...
The different requests that can be sent to the server are defined in the appendix for the \term{API} 
\ref{app:API}.
...
The front end consist of a handler for the \term{API} requests mentioned above. The handler parses incomming request and passes them through to either processing or data storage depending request type.
