...
From the \term{FileView}, the user can select any number of files to add to a list of currently selected files by tapping the star next to each file name. After that, the user can press the \term{Star tab} to go to the \term{Selected Files View}. This sequence is shown in \refer{fig:ios_sequence_file_selection}
