...
The user can choose which annotations to display in the result view, more annotations have been added in \refer{fig:ios_searchResult2}b. This gives the user the possibility to only show the annotations which are interesting at the moment. 
...
\begin{figure}[ht]
\addTwoImages	{ios_convert1.PNG}{a}
		{ios_convert2.PNG}{b}
...
\begin{figure}[ht]
\addTwoImages	{ios_convert3.PNG}{a}
		{ios_alert1.PNG}{b}
