...
\begin{figure}[ht]
\addScaledImage{0.1}{figures/andLogin.png}
...
\begin{figure}[ht]
\addScaledImage{0.1}{figures/andResult.png} 
...
\begin{figure}[ht]
\addScaledImage{0.1}{figures/andExperiment.png} 
...
\begin{figure}[h]
\addScaledImage{0.4}{figures/and_selectedfiles.JPG} 
...
\begin{figure}[h]
\addScaledImage{0.1}{figures/and_convert.png}
