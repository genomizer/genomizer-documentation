...
The design illustrated in \refer{fig:and_result} below show the search result view. 
...
The button \click{Add to selection} will be used to send selected files to the conversion view.

\begin{figure}[ht]
\addScaledImage{0.3}{figures/and_experiment_files.png} 
...
The design illustrated in \refer{fig:and_selected} shows the view for selecting files.
...
\begin{figure}[h]
\addScaledImage{0.3}{figures/and_selected_files.png} 
